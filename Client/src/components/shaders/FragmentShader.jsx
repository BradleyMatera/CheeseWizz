...
// Original shader by Shane (https://www.shadertoy.com/view/MfjyWK)
...
vec4 plane(vec3 ro, vec3 rd, vec3 pp, vec3 npp, float apd, vec3 cp, vec3 off, float n) {
  vec4 col = vec4(0.0);
  vec2 p2 = pp.xy - off.xy;
  float aa = fwidth(p2.x);
